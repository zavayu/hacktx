            ...
            <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 flex items-center justify-center py-12 px-4">
                ...
                >
                    ...
                    <p className="text-gray-600 mb-6">
                        To see your personalized dashboard, please complete the
                        onboarding survey and link your bank account.
                    </p>
                    <a
                        href="/survey"
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600">
                        We've analyzed {customerName}'s spending patterns to
                        create your unique financial profile.
                    </p>
                </motion.div>
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-green-600">
                                    {profile.topCategory.category}
                                </p>
                                <p className="text-sm text-gray-500">
                                    {formatPercentage(
                                        profile.topCategory.percentage
                                    )}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="relative w-64 h-64 mx-auto">
                            ...
                            >
                                ...
                                {radarData.labels.map((label, index) => {
                                    ...
                                    const x =
                                        100 +
                                        80 * Math.cos(angle - Math.PI / 2);
                                    const y =
                                        100 +
                                        80 * Math.sin(angle - Math.PI / 2);
